...
var parser = module.exports = {
  ...
  createChart: function(type, data) {
    if(type == 'payments') {
      ...
      var line = Quiche('line');
      line.setTitle('Comparativa');
      line.addData(data.sales, 'Ventas', '008000');
      line.addAxisLabels('x', ['Hoy', '1 sem', '2 sem', '3 sem']);
      line.setAutoScaling();
      line.setTransparentBackground();
      return line.getUrl(true);
    }
  }
};
